...
################################################################################
# final automatic tuning RF + feature importance
################################################################################
...
imp = as.data.frame(at$importance())
...
at$learner$model
at$learner$model$beta
tmp = coef(at$learner$model, s = at$tuning_instance$result$s, 
           alpha = at$tuning_instance$result$alpha)
